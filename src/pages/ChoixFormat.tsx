  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      if (paymentResult.success) {
        ...
        const pdfUrl = selectedFormat === 'pdf' || selectedFormat === 'pack' 
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-6">
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">
            Choisissez votre format et finalisez votre commande
          </span>
        </h1>
        
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="lg:col-span-2 space-y-8">
              ...
              <Card className="p-6">
                ...
                <DeliveryForm 
                  ...
                  showAddressFields={selectedFormat !== 'pdf'} 
