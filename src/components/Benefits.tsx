    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center relative transform scale-110 z-10">
            ...
            <div className="w-24 h-24 bg-yellow-100 rounded-full flex items-center justify-center mb-4 shadow-lg">
              <img 
                src="/lovable-uploads/42d2ab14-7e86-4008-9f16-3a830a09c095.png" 
                alt="Pack Icon" 
