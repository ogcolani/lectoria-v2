...
const HowItWorks = () => {
  return (
    <section id="how-it-works" className="py-16 bg-purple-100">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm flex">
              ...
              <div>
                ...
                <p className="text-gray-600">Sélectionnez une aventure et personnalisez le héros</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm flex">
              ...
              <div>
                ...
                <p className="text-gray-600">Vérifiez votre histoire et passez à la commande</p>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm flex">
              ...
              <div>
                <h3 className="font-bold text-lg mb-2">Profitez</h3>
                <p className="text-gray-600">Recevez votre livre personnalisé en quelques jours</p>
              </div>
            </div>
          </div>
